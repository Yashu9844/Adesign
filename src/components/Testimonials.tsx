...
const testimonials = [
  {
    id: 1,
    quote:
      'The attention to detail and performance optimization they brought to Code Quest was incredible. They delivered a portfolio that not only looks stunning but handles everything flawlessly without breaking a sweat.',
    author: 'Harsha Vardhan',
    role: 'CTO',
    company: 'Code Quest',
    image: '/testimonials/harsh4x5.jpg',
    metric: '< 0.5s',
  ...
  },
  {
    id: 2,
    quote:
      'Their AI data extraction workflow completely revolutionized how we handle documentation. What used to take our data entry team hours is now done in seconds with perfect accuracy. It\'s an absolute game-changer for our productivity.',
    author: 'Prakash Garai',
