...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1920px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 text-center">
          ...
          >
            ...
            <span className="text-xs sm:text-sm text-white/60 tracking-[0.3em] uppercase">What We Do</span>
            <div className="w-12 h-px bg-white/40" />
          </motion.div>
          ...
          <h1
            ref={titleRef}
            className="text-[15vw] sm:text-[12vw] md:text-[10vw] font-accent font-black text-white leading-[0.85] tracking-[-0.04em] perspective-1000"
          >
          ...
          <motion.p
            ...
            className="mt-8 text-lg sm:text-xl md:text-2xl text-white/60 max-w-2xl mx-auto font-light"
          >
      ...
      <section ref={servicesRef} className="relative py-24 sm:py-32 lg:py-40 bg-black overflow-hidden">
        {/* Section Header */}
        <div className="w-full max-w-[1920px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 mb-16 sm:mb-24">
          ...
          >
            <div>
              <span className="text-xs text-white/40 tracking-[0.3em] uppercase mb-4 block">Our Expertise</span>
      ...
      <Link href={service.href} className="block group">
        <div className="relative h-full min-h-[400px] sm:min-h-[450px] bg-white/[0.02] border border-white/10 p-6 sm:p-8 overflow-hidden transition-all duration-500 hover:bg-white/[0.04] hover:border-white/20">
          ...
          <div className="relative z-10 flex items-start justify-between mb-8">
            <span className="text-6xl sm:text-7xl font-accent font-black text-white/5 group-hover:text-white/10 transition-colors duration-500">
              {service.number}
            </span>
            <div className="w-12 h-12 flex items-center justify-center border border-white/10 group-hover:border-white/30 group-hover:bg-white/5 transition-all duration-300">
          ...
          <div className="relative z-10 space-y-4 pb-24">
            <div>
              ...
              <p className="text-sm text-white/40 tracking-wide">{service.tagline}</p>
            </div>
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              {service.features.slice(0, 3).map((feature) => (
                <span
                  key={feature}
                  className="px-3 py-1 text-[10px] sm:text-xs text-white/50 bg-white/5 border border-white/10 tracking-wide"
                >
                  {feature}
                </span>
              ))}
          ...
          <div className="absolute bottom-6 sm:bottom-8 left-6 sm:left-8 right-6 sm:right-8 flex items-end justify-between z-10">
            ...
            <div className="w-10 h-10 flex items-center justify-center border border-white/20 group-hover:bg-white group-hover:border-white transition-all duration-300">
              <ArrowUpRight className="w-4 h-4 text-white/60 group-hover:text-black transition-colors" />
            </div>
          </div>

          {/* Decorative corner */}
          <div className="absolute top-0 right-0 w-20 h-20 border-t border-r border-white/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
        </div>
      </Link>
    </motion.div>
  );
  ...
  return (
    <section ref={sectionRef} className="relative py-24 sm:py-32 lg:py-40 bg-black overflow-hidden">
      <div className="w-full max-w-[1920px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20">
        ...
        >
          <span className="text-xs text-white/40 tracking-[0.3em] uppercase mb-4 block">How We Work</span>
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-accent font-bold text-white">
            Our Process
          </h2>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-4">
            {steps.map((step, index) => (
              ...
              >
                {/* Step number */}
                <div className="inline-flex items-center justify-center w-16 h-16 mb-6 border border-white/20 bg-black relative z-10">
                  <span className="text-xl font-accent font-bold text-white">{step.number}</span>
                </div>

                <h3 className="text-xl font-accent font-bold text-white mb-2">{step.title}</h3>
    ...
    <section ref={sectionRef} className="relative py-32 sm:py-40 lg:py-52 bg-black overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1920px] mx-auto px-5 sm:px-8 md:px-12 lg:px-16 xl:px-20 text-center">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <span className="text-xs text-white/40 tracking-[0.3em] uppercase mb-6 block">Ready to Start?</span>
