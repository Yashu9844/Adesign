          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div ref={formRef} className="lg:col-span-7">
              ...
              >
                {/* Form Container */}
                <div 
                  className="p-8 sm:p-10 md:p-12 backdrop-blur-sm"
                  style={{ 
                    backgroundColor: 'var(--bg-card)', 
                    border: '1px solid var(--border-medium)' 
                  }}
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="group relative w-full sm:w-auto px-10 py-5 text-sm font-medium tracking-[0.2em] uppercase transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed font-kh-teka"
                      style={{ 
                      ...
                      {loading ? (
                        <>
                          <div 
                            ...
                            style={{ borderColor: 'var(--cta-primary-text)', borderTopColor: 'transparent' }}
                          />
                          Sending...
                        </>
                      ) : (
